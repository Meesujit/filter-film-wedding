                  ...
                  team.map((member) => (
                    <tr key={member.id ?? member.email} className="hover:bg-muted/30 cursor-pointer">
                      ...
                      <td className="p-3 text-center space-x-2">
                        ...
                        <Button variant="ghost" size="sm" onClick={() => openDeleteModal(member.id)}>
            ...
            <div className="bg-card rounded-xl shadow-card max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              <form onSubmit={handleSubmit} className="p-6 space-y-4">
                ...
                <div className="flex justify-end space-x-3 pt-4">
                  <Button type="button" variant="ghost" onClick={() => { setIsModalOpen(false); resetForm(); }} disabled={loading || isUploading}>
                    Cancel
                  </Button>
