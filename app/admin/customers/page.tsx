...
import { Loader2, Eye, Trash2, Search, Edit, Upload } from "lucide-react";
                  ...
                  filteredCustomers.map((customer) => (
                    <tr key={customer.id ?? customer.email} className="hover:bg-muted/30">
                      ...
                      <td className="p-3 text-center space-x-2">
                        ...
                        <Button variant="ghost" size="sm" onClick={() => openDeleteModal(customer.id)}>
            ...
            <div className="bg-card rounded-xl shadow-card max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              <div className="p-6 space-y-6">
                ...
                <div className="flex justify-end pt-4">
                  <Button variant="royal" onClick={() => setViewModalOpen(false)}>
                    Close
                  </Button>
                </div>
              </div>
